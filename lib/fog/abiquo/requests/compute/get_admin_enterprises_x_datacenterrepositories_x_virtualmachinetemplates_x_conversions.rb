module Fog
  module Compute
    class Abiquo
      class Real
        def get_admin_enterprises_x_datacenterrepositories_x_virtualmachinetemplates_x_conversions(enterprise, datacenterrepository, virtualmachinetemplate, options = {})
          request(
            :expects  => [200],
            :method   => 'GET',
